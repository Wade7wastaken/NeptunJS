...
+(function () {
	...
	function _0x13E9F() {
		...
		_0x13E73.on("vast.adStart", function () {
			Neptq("#" + NCSS + NCSS + NCSS + NCSS + NCSS + NCSS + "3").attr(
				"style",
	...
	function _0x13ECB() {
		...
		_0x13E73.on("vast.adStart", function () {
			...
			Neptq("#" + NCSS + NCSS + NCSS + NCSS + NCSS + NCSS + "2").attr(
				"style",
				"display: block !important"
			);
			...
			function _0x13E1B() {
				...
				if (_0x13E47.innerHTML == 0) {
					Neptq("#" + NCSS + "adtimers").attr(
						"style",
						"display: none !important"
					);
					Neptq("#" + NCSS + "SkipADS").click(function () {
						Neptq("#" + NCSS + "SkipADS").attr(
							"style",
							"display: none !important"
						);
						Neptq("#" + NCSS + NCSS + NCSS + NCSS + NCSS + NCSS + "2").css(
							"display",
							"none"
						);
						Neptq(
							"#" + NCSS + NCSS + NCSS + NCSS + NCSS + NCSS + "2_html5_api"
						).prop("volume", 0.0);
						Neptq("." + NCSS + "NeptunButton").attr(
							"style",
							"display: block !important"
						);
					});
			...
			setTimeout(_0x13E1B, 1000);
			Neptq("#" + NCSS + NCSS + NCSS + NCSS + NCSS + NCSS + "2_html5_api").prop(
				"volume",
				0.3
			);
		});
	...
	function _0x13F4F() {
		Neptq("#" + NCSS + "SkipADS").css("display", "block");
		Neptq("#" + NCSS + NCSS + NCSS + NCSS + NCSS + NCSS + "").css(
			"display",
			"block"
		);
		...
		function _0x13E1B() {
			...
			if (_0x13E47.innerHTML == 0) {
				...
				Neptq("#" + NCSS + "SkipADS").click(function () {
					...
					Neptq("#" + NCSS + NCSS + NCSS + NCSS + NCSS + NCSS + "").removeClass(
						"displayBlock"
					);
					Neptq(
						"#" + NCSS + NCSS + NCSS + NCSS + NCSS + NCSS + "_html5_api"
					).prop("volume", 0.0);
					Neptq("." + NCSS + "NeptunButton").attr(
						"style",
						"display: block !important"
		...
		setTimeout(_0x13E1B, 1000);
		Neptq("#" + NCSS + NCSS + NCSS + NCSS + NCSS + NCSS + "").addClass(
			"displayBlock"
		);
		Neptq("#" + NCSS + NCSS + NCSS + NCSS + NCSS + NCSS + "_html5_api").prop(
			"volume",
			0.3
		);
	}
	...
	function _0x13F7B() {
		...
		Neptq("#" + NCSS + NCSS + NCSS + NCSS + NCSS + NCSS + "").attr(
			"style",
			"z-index: 0"
		);
		if (AdsSkiped === true) {
	...
	function _0x13FFF() {
		...
		if (HeightCheker > 400) {
			...
			NJS_Elements.css(
				"height",
				"" + Neptq("#" + NCSS + "EmuBlock ").width() / 1.336 + "px"
			);
		}
		_0x13FD3();
	}
	...
	function _0x14057() {
		if (
			Neptq("." + NCSS + "volume").hasClass("nep-icon-volume-high") ||
			nepVolume > 0.05
		) {
		...
		var _0x13E1B = setTimeout(function () {
			Neptq("." + NCSS + "nep_mute_game").removeClass(
				"" + NCSS + "active_info"
			);
		}, 2000);
	}
	...
	function _0x14083() {
		...
		function _0x13E1B(_0x13E1B) {
			...
			return _0x13E73 === null
				? ""
				: decodeURIComponent(_0x13E73[1].replace(/\+/g, " "));
		}
		if (
			NeptunP === "segaCD" ||
			NeptunP === "tg16CD" ||
			...
			_0x13E47(
				_0x13E1B("engine") || "https://mem.neptunjs.com/njs/gge/CDloader.gge"
			);
		}
		if (NepZoom === "enable") {
				...
				function _0x13E1B(_0x13EF7, _0x14107) {
					...
					if (
						...
						Neptq(function () {
							var _0x13E1B;
							Neptq(
								"." + NCSS + "emu-ctr-bar , #" + NCSS + "videoSettings"
							).mouseleave(function (_0x13E47) {
								clearTimeout(_0x13E1B);
								_0x13E1B = setTimeout(function () {
									Neptq("." + NCSS + "emu-ctr-bar").removeClass(
										NCSS + "activeBR"
									);
								}, 700);
							}),
								Neptq(
									"#" + NCSS + "Neptun , " + NCSS + "CfullScreen"
								).mousemove(function (_0x13E47) {
						...
						var _0x13E1B =
							"//mem.neptunjs123.xyz/neptun/ggew/" + neptunPlatform + ".gge";
						var _0x13E73 =
							"//mem.neptunjs1234.xyz/neptun/gge/" + neptunPlatform + ".gge";
						var _0x13E9F =
							"//mem.neptunjs12345.xyz/neptun/gge/" +
							neptunPlatform +
							"_xbox.gge";
						if (
							NselectGameLang === "RusJp" ||
							NselectGameLang === "Rus" ||
							NselectGameLang === "Jp"
						) {
						...
						function _0x1415F() {
							...
							Neptune = {
								...
								print: function (_0x13E1B) {
									var _0x13E1B = Array.prototype.slice
										.call(arguments)
										.join(" ");
								},
								printErr: function (_0x13E1B) {
									...
									if (
										_0x13E1B.indexOf(
											"RetroArch [ERROR] :: cannot push NULL or empty core name into the playlist."
										) !== -1
									) {
									...
									if (_0x13E1B.indexOf("RetroArch [INFO] :: Paused.") > -1) {
										if (
											Neptq("." + NCSS + "emul-pause").css("display") ===
											"block"
										) {
										} else {
											Neptq("." + NCSS + "emul-pause").css("display", "block");
											Neptq("#" + NCSS + "VmenuNjs").attr(
												"data-click-state",
												0
											);
											Neptq("#" + NCSS + "videoSettings").css(
												"display",
												"none"
											);
										}
									...
									if (
										_0x13E1B.indexOf(
											"RetroArch [INFO] :: Ejected virtual disk tray."
										) > -1
									) {
									} else {
									}
							...
							Neptq("#" + NCSS + NCSS2 + NCSS3 + "").removeClass(
								"" + NCSS + "pulse-anim"
							);
							...
							if (NeptunP === "n64") {
								...
								if (
									Neptq("#Accuracy2 , #Accuracy3 , #Accuracy4 ").is(":selected")
								) {
									N64Acurate = "_v2";
								}
							}
							if (
								...
								NeptunP === "arcade" ||
								NeptunP === "sega32x" ||
								(NeptunP === "sega32x" && load_wasm == true) ||
								(NeptunP === "arcade" && load_wasm == true) ||
								NeptunP === "cps3" ||
								(NeptunP === "cps3" && load_wasm == true)
							) {
								load_proteus = load_proteus =
									"https://mem.neptunjs.com/njs/gga/" +
									neptunPlatform +
									N64Acurate +
									".gge";
							} else {
								if (load_wasm === true) {
									...
									load_proteus =
										"cores/" + neptunPlatform + N64Acurate + ".gge";
								}
							}
							var _script = document.createElement("script");
							_script.setAttribute("data-name", llms + "data_njs2");
							_script.src = "cores/dataload.gge";
						...
						(function () {
							if (ChangeDisc > 0) {
								...
								Neptq("." + NCSS + "loader_emu").css("display", "block");
								Neptq("#" + NCSS + NCSS2 + NCSS3 + "").css("display", "none");
								Neptq("." + NCSS + "loader_emu").html(
									"Load " + getZipName + " CD " + ChangeDisc + " ...."
								);
								MCDload = 1;
								...
								request.onsuccess = function (_0x13E47) {
									...
									var _0x13ECB = _0x13E1B.transaction(
										["FILE_DATA"],
										"readwrite"
									);
									var _0x13E73 = _0x13ECB.objectStore("FILE_DATA");
									console.log(NameDisc);
									var _0x13E9F = _0x13E73.get(
										"/webdata/state/" + NameDisc + ".state"
									);
								...
								Neptq("#" + NCSS + "saveuploadSwap, #file").on(
									"change",
									function _0x13E1B(_0x13E1B) {
										var _0x13E73 = _0x13E1B.target.files;
										for (
											var _0x13E9F = 0;
											_0x13E9F < _0x13E73.length;
											_0x13E9F++
										) {
								...
								function _0x13E47(_0x13E47, _0x13E9F, _0x13E73) {
									...
									_0x13ECB.onsuccess = function (_0x13E73) {
										...
										var _0x13EF7 = _0x13E47.transaction(
											["FILE_DATA"],
											"readwrite"
										);
										var _0x13E9F = _0x13EF7.objectStore("FILE_DATA");
										var _0x13ECB = _0x13EF7
											.objectStore("FILE_DATA")
											.put(_0x13E1B, "/webdata/state/" + NameDisc + ".state");
										Neptq("#" + NCSS + "popupSwap3").css({
											visibility: "hidden",
											opacity: "0",
											zIndex: "0",
						...
						Neptq("." + NCSS + "checkbox").on("click", function () {
							...
							if (Neptq("#NJSshaders1").is(":checked")) {
								...
								if (
									...
									Neptq("#" + NCSS + "warningInfo").addClass(
										"" + NCSS + "warningShow"
									);
								} else {
							...
							if (Neptq("#NJSshaders7").is(":checked")) {
								...
								if (
									(NeptunP === "sega" && load_asm === true) ||
									(NeptunP === "segaCD" && load_asm) ||
									(NeptunP === "segaMS" && load_asm === true) ||
									(NeptunP === "segaGG" && load_asm === true) ||
									NeptunP === "sega32x"
								) {
									RA.context.close();
						...
						Neptq("#" + NCSS + "display , #" + NCSS + "emul-display").click(
							function () {
								Neptq("#" + NCSS + "videoSettings").css("display", "none");
							...
							if (
								...
								if (Neptq(" #NJSshaders1").is(":checked")) {
									...
									if (Neptq("#NJSshaders6").is(":checked")) {
										...
										if (
											Neptq(
												" #NJSshaders2 , #NJSshaders3 , #NJSshaders4 , #NJSshaders5 "
											).is(":checked")
										) {
										} else {
											Neptune.ccall("ytrdvbuj4578", "x7ooiujgfgda"[1]);
						...
						function _0x141E3() {
							...
							Neptq(document).mouseup(function (_0x13E73) {
								var _0x13E47 = Neptq("#" + NCSS + "Neptun");
								var _0x13E9F = Neptq("." + NCSS + "nep_swap_disc").attr(
									"data-swap"
								);
								if (
									!_0x13E47.is(_0x13E73.target) &&
									_0x13E47.has(_0x13E73.target).length === 0
								) {
									if (MultiCD == true) {
										if (_0x13E9F == 1 && ChangeDisc > 0) {
										} else {
											if (
												Neptq("." + NCSS + "emul-pause").css("display") ===
												"block"
							...
							function _0x13EF7() {
								Neptq("." + NCSS + "nep_save_game").addClass(
									"" + NCSS + "active_info"
								);
								var _0x13E1B = setTimeout(function () {
									Neptq("." + NCSS + "nep_save_game").removeClass(
										"" + NCSS + "active_info"
									);
								}, 2000);
								Neptune.ccall("trgfsdsse879", "x7ooiujgfgda"[1]);
							...
							function _0x13E47() {
								Neptq("." + NCSS + "nep_load_game").addClass(
									"" + NCSS + "active_info"
								);
								var _0x13E1B = setTimeout(function () {
									Neptq("." + NCSS + "nep_load_game").removeClass(
										"" + NCSS + "active_info"
									);
								}, 2000);
							...
							Neptq("." + NCSS + "NEPicon-restart").click(function _0x13E9F() {
								Neptq("." + NCSS + "nep_reset_game").addClass(
									"" + NCSS + "active_info"
								);
								var _0x13E1B = setTimeout(function () {
									Neptq("." + NCSS + "nep_reset_game").removeClass(
										"" + NCSS + "active_info"
									);
								}, 2000);
						...
						function _0x13F7B(_0x13E1B, _0x13E47) {
							...
							return (
								parseFloat(
									(_0x13E1B / Math.pow(_0x13ECB, _0x13E9F)).toFixed(_0x13E73)
								) +
								" " +
								_0x13EF7[_0x13E9F]
							);
										...
										_0x13E47.addEventListener("progress", function (_0x13E73) {
											if (_0x13E73.lengthComputable) {
												...
												_0x13E47.onload = function () {
													...
													BrowserFS.FileSystem.ZipFS.computeIndex(
														_0x13ECB,
														function (_0x13FFF, _0x13FD3) {
															var _0x13F7B = new BrowserFS.FileSystem.ZipFS(
																_0x13FFF
															);
															...
															for (var _0x13F4F in _0x13E73) {
																...
																if (_0x13FA7 === null) {
																	...
																	var _0x13ECB =
																		"." + _0x13EF7[_0x13EF7.length - 1] + "";
																	var _0x13F23 =
																		_0x13FA7.input.indexOf(_0x13ECB);
																	RomTitleCD = _0x13FA7.input.substring(
																		0,
																		_0x13F23 != -1
																			? _0x13F23
																			: _0x13FA7.input.length
																	);
												...
												var _0x13EF7 = Math.ceil(
													(_0x13E73.loaded / _0x13E73.total) * 100
												);
												Neptq("#" + NCSS + "progressstate").css(
													"width",
													"" + _0x13EF7 + "%"
												);
											} else {
												_0x13E47.onload = function () {
													...
													BrowserFS.FileSystem.ZipFS.computeIndex(
														_0x13E9F,
														function (_0x13FD3) {
															var _0x13F4F = new BrowserFS.FileSystem.ZipFS(
																_0x13FD3
															);
															...
															for (var _0x13F23 in _0x13E73) {
																...
																if (_0x13FA7 === null) {
																	...
																	var _0x13E9F =
																		"." + _0x13ECB[_0x13ECB.length - 1] + "";
																	var _0x13EF7 =
																		_0x13FA7.input.indexOf(_0x13E9F);
																	var _0x13F7B = _0x13FA7.input.substring(
																		0,
																		_0x13EF7 != -1
																			? _0x13EF7
																			: _0x13FA7.input.length
								...
								if (_0x13E73.status == 200) {
									_0x13E73.addEventListener("progress", function (_0x13E9F) {
										if (_0x13E9F.lengthComputable) {
											...
											var _0x13F23 = Math.ceil(
												(_0x13E9F.loaded / _0x13E9F.total) * 100
											);
											Neptq("#" + NCSS + "progressstate").css(
												"width",
												"" + _0x13F23 + "%"
									...
									Neptq("." + NCSS + "game-load").html(
										"Download bios file error"
									);
								}
							};
									...
									if (_0x13E73.status == 200) {
										_0x13E73.addEventListener("progress", function (_0x13E47) {
											if (_0x13E47.lengthComputable) {
												...
												var _0x13EF7 = Math.ceil(
													(_0x13E47.loaded / _0x13E47.total) * 100
												);
												Neptq("#" + NCSS + "progressstate").css(
													"width",
													"" + _0x13EF7 + "%"
						...
						function _0x13FA7(
							...
							if (
								_0x13F4F === "nes" ||
								(_0x13F4F === "sega" && load_asm === true) ||
								(_0x13F4F === "segaCD" && load_asm) ||
								(_0x13F4F === "segaMS" && load_asm === true) ||
								(_0x13F4F === "segaGG" && load_asm === true) ||
								_0x13F4F === "sega32x"
							) {
							} else {
								if (
									...
									_0x13E1B +=
										"video_filter = :/filters/video/Blargg_NTSC_SNES_Composite.filt\n";
								}
							}
							if (Neptq("#NJSshaders1").is(":checked")) {
								infoInner = shadersOP1;
								...
								if (Neptq("#NJSshaders2").is(":checked")) {
									...
									if (Neptq("#NJSshaders3").is(":checked")) {
										infoInner = shadersOP3;
										_0x13E1B +=
											"video_filter = :/filters/video/Blargg_NTSC_SNES_S-Video.filt\n";
										_0x13E47 += "nestopia_blargg_ntsc_filter = svideo\n";
									} else {
										if (Neptq("#NJSshaders4").is(":checked")) {
											infoInner = shadersOP4;
											_0x13E1B +=
												"video_filter = :/filters/video/Blargg_NTSC_SNES_monochrome.filt\n";
											_0x13E47 += "nestopia_blargg_ntsc_filter = monochrome\n";
										} else {
											if (Neptq("#NJSshaders5").is(":checked")) {
												infoInner = shadersOP5;
												_0x13E1B +=
													"video_filter = :/filters/video/Blargg_NTSC_SNES_RF.filt\n";
												...
												if (Neptq("#NJSshaders6").is(":checked")) {
													...
													if (
														...
														_0x13E1B +=
															"video_filter = :/filters/video/Phosphor2x.filt\n";
													} else {
														_0x13E1B +=
															"video_filter = :/filters/video/Blargg_NTSC_SNES_Composite.filt\n";
													}
							...
							_0x13E1B +=
								"input_player1_menu_toggle_btn = nul\ninput_autodetect_enable = false\nvideo_scale_integer = false\ninput_max_users = 4\naudio_driver = rwebaudio\n";
							if (_0x13F4F === "psx") {
							...
							Neptq("." + NCSS + "selectOP").change(function () {
								...
								if (Neptq("#" + _0x13E1B).is(":selected")) {
									if (
										Neptq("." + NCSS + "nep_numL").hasClass(
											"" + NCSS + "active_info"
										)
									) {
									} else {
										Neptq("." + NCSS + "nep_numL").addClass(
											"" + NCSS + "active_info"
										);
										var _0x13E47 = setTimeout(function () {
											Neptq("." + NCSS + "nep_numL").removeClass(
												"" + NCSS + "active_info"
											);
										}, 6000);
									}
							...
							if (
								...
								Neptq(
									"#NJSshaders1 ,#NJSshaders2 ,#NJSshaders3 ,#NJSshaders4 ,#NJSshaders5 ,#NJSshaders6 ,#NJSshaders7"
								).click(function () {
									if (
										Neptq("." + NCSS + "nep_numL").hasClass(
											"" + NCSS + "active_info"
							...
							if (_0x13F4F === "sega32x" || _0x13F4F === "sega32X") {
								Neptune.FS_createDataFile(
									"/home/emscripten/retroarch/userdata/",
									"retroarch.cfg",
									_0x13E1B,
									true,
									true
						...
						function _0x1420F(_0x13E47, _0x13E1B, _0x13FFF) {
							...
							_0x1402B.onsuccess = function (_0x13E47) {
								if (this.result.objectStoreNames.length === 0) {
								} else {
									var _0x13E1B = this.result;
									if (
										_0x13FFF === "psx" ||
									...
									var _0x13EF7 = _0x13E1B.transaction(
										["FILE_DATA"],
										"readwrite"
									);
									var _0x13ECB = _0x13EF7.objectStore("FILE_DATA");
									_0x13EF7.objectStore("FILE_DATA").get(_0x13E9F).onsuccess =
										function (_0x13E1B) {
											if (_0x13E1B.target.result === undefined) {
											} else {
												checkOldsave = 1;
							...
							if (Neptq("#" + NCSS + "display").is(":focus")) {
							} else {
								if (
									Neptq("." + NCSS + "emul-pause").css("display") === "block"
								) {
							...
							Neptq("." + NCSS + "NeptunContextMenu").insertAfter(
								"CfullScreen"
							);
							Neptq(document).keyup(function (_0x13E1B) {
								if (_0x13E1B.keyCode === 27) {
									Neptq("#" + NCSS + "display").removeClass(
										"" + NCSS + "CfullScreen"
									);
								}
							});
							...
							function _0x13F23() {
								if (
									window.innerHeight == Neptq("#" + NCSS + "Neptun").height()
								) {
									...
									if (_0x13FFF === "sega32x" || _0x13FFF === "sega32X") {
									} else {
										RA.context.close();
										Neptune.ccall("axiop55x2218", "x7ooiujgfgda"[1]);
									}
							...
							Neptq(window).blur(function () {
								if (MultiCD == true) {
									var _0x13E1B = Neptq("." + NCSS + "nep_swap_disc").attr(
										"data-swap"
									);
									if (_0x13E1B == 1 && ChangeDisc > 0) {
									} else {
										if (
											Neptq("." + NCSS + "emul-pause").css("display") ===
											"block"
							...
							Neptq(function () {
								...
								Neptq(_0x13E1B).nuContextMenu({
									...
									callback: function (_0x13E47, _0x13E1B, _0x13E73) {
										...
										if (_0x13E47 == 3) {
											Neptq("." + NCSS + "nep_Qsave_game").addClass(
												"" + NCSS + "active_info"
											);
											_0x13E73 = setTimeout(function () {
												Neptq("." + NCSS + "nep_Qsave_game").removeClass(
													"" + NCSS + "active_info"
												);
											}, 3000);
											Neptune.ccall("trgfsdsse879", "x7ooiujgfgda"[1]);
								...
								if (_0x13FFF === "atari_jaguar") {
									Neptq(
										"li[data-key='3'] , li[data-key='4'], li[data-key='9']"
									).css("display", "none");
								}
							});
							...
							_0x13ECB.contextmenu(function () {
								if (popset === 1) {
									var _0x13E9F = Neptq(
										"." + NCSS + "NeptunContextMenu"
									).width();
									var _0x13E1B = Neptq(
										"." + NCSS + "NeptunContextMenu"
									).height();
									var _0x13E73 =
										Neptq("." + NCSS + "NeptunContextMenu").position()["top"] +
										Neptq("." + NCSS + "NeptunContextMenu").height();
									var _0x13E47 =
										Neptq("." + NCSS + "NeptunContextMenu").position()["left"] +
										Neptq("." + NCSS + "NeptunContextMenu").width();
									var _0x13EF7 = Neptq("#" + NCSS + "Neptun").width();
									var _0x13ECB = Neptq("#" + NCSS + "Neptun").height();
									if (_0x13EF7 < _0x13E47) {
										Neptq("." + NCSS + "NeptunContextMenu").css(
											"left",
											"" + _0x13EF7 - _0x13E9F + "px"
										);
									}
									if (_0x13ECB < _0x13E73) {
										Neptq("." + NCSS + "NeptunContextMenu").css(
											"top",
											"" + _0x13ECB - _0x13E1B + "px"
										);
									}
								}
							});
							...
							gamepad.bind(Gamepad.Event.UNSUPPORTED, function (_0x13E1B) {
								...
								Neptq("." + NCSS + "nep_game_pad_connect").addClass(
									"" + NCSS + "active_info"
								);
								_0x14293 = setTimeout(function () {
									Neptq("." + NCSS + "nep_game_pad_connect").removeClass(
										"" + NCSS + "active_info"
									);
								}, 4500);
								Neptq(
							...
							gamepad.bind(Gamepad.Event.CONNECTED, function (_0x13E1B) {
								...
								_0x13E73 = _0x13E73.substring(
									0,
									_0x13E47 != -1 ? _0x13E47 : _0x13E73.length
								);
								if (_0x13E1B.index === 0) {
									...
									if (
										Neptq("#" + NCSS + "P1").hasClass("" + NCSS + "is-active")
									) {
										Neptq(
											"#" + NCSS + "gbadinfo1 , #" + NCSS + "gamepadinfo1"
										).css("display", "block");
										Neptq("#" + NCSS + "gbadinfo1").addClass(
											"" + NCSS + "is-active"
										);
									}
								} else {
									if (
										Neptq("#" + NCSS + "gbadinfo1").hasClass(
											"" + NCSS + "is-active"
										)
									) {
									} else {
								...
								if (_0x13E1B.index === 1) {
									...
									if (
										Neptq("#" + NCSS + "P2").hasClass("" + NCSS + "is-active")
									) {
										Neptq(
											"#" + NCSS + "gbadinfo2 , #" + NCSS + "gamepadinfo2"
										).css("display", "block");
										Neptq("#" + NCSS + "gbadinfo2").addClass(
											"" + NCSS + "is-active"
										);
									}
								} else {
									if (
										Neptq("#" + NCSS + "gbadinfo2").hasClass(
											"" + NCSS + "is-active"
										)
									) {
									} else {
								...
								if (_0x13E1B.index === 2) {
									...
									if (
										Neptq("#" + NCSS + "P3").hasClass("" + NCSS + "is-active")
									) {
										Neptq(
											"#" + NCSS + "gbadinfo3, #" + NCSS + "gamepadinfo3"
										).css("display", "block");
										Neptq("#" + NCSS + "gbadinfo3").addClass(
											"" + NCSS + "is-active"
										);
									}
								} else {
									if (
										Neptq("#" + NCSS + "gbadinfo3").hasClass(
											"" + NCSS + "is-active"
										)
									) {
									} else {
								...
								if (_0x13E1B.index === 3) {
									...
									if (
										Neptq("#" + NCSS + "P4").hasClass("" + NCSS + "is-active")
									) {
										Neptq(
											"#" + NCSS + "gbadinfo4 , #" + NCSS + "gamepadinfo4"
										).css("display", "block");
										Neptq("#" + NCSS + "gbadinfo4").addClass(
											"" + NCSS + "is-active"
										);
									}
								} else {
									if (
										Neptq("#" + NCSS + "gbadinfo4").hasClass(
											"" + NCSS + "is-active"
										)
									) {
									} else {
								...
								Neptq("." + NCSS + "gamepadinfo").html(
									"gamepad №" + (_0x13E1B.index + 1) + ": " + _0x13E73 + ""
								);
								Neptq("." + NCSS + "nep_game_pad_connect").addClass(
									"" + NCSS + "active_info"
								);
							...
							gamepad.bind(Gamepad.Event.DISCONNECTED, function (_0x13E1B) {
								if (_0x13E1B.index === 0) {
									...
									Neptq("#" + NCSS + "gbadinfo1").removeClass(
										"" + NCSS + "is-active"
									);
								}
								if (_0x13E1B.index === 1) {
									...
									Neptq("#" + NCSS + "gbadinfo2").removeClass(
										"" + NCSS + "is-active"
									);
								}
								if (_0x13E1B.index === 2) {
									...
									Neptq("#" + NCSS + "gbadinfo3").removeClass(
										"" + NCSS + "is-active"
									);
								}
								if (_0x13E1B.index === 3) {
									...
									Neptq("#" + NCSS + "gbadinfo4").removeClass(
										"" + NCSS + "is-active"
									);
								}
								var _0x13E73 = _0x13E1B.id;
	...
	function _0x14267() {
		...
		FS.rename(
			"/webdata/state/" + NameDisc + ".state",
			"/webdata/state/" + GetsaveName + ".state"
		);
	...
	if (netp === 1) {
		...
		adslink =
			"//a.vertamedia.com/?content_page_url={content_page}&width={width}&height={height}&cb={cb}&vpaid_type=3&video_duration=300&aid=365491";
		if (window.vqn == undefined || ltm === false || rbtl === true) {
		} else {
			...
			player.vastClient({
				adTagUrl: [
					"//server.cpmstar.com/view.aspx?poolid=75083&vast=2&vpaid=1",
					"//server.cpmstar.com/view.aspx?poolid=75143&vast=2&vpaid=1",
				],
				playAdAlways: false,
