...
+(function () {
	...
	function _0x13FA7() {
		...
		Neptq("." + NCSS + "labButtonSelect").html(
			"<span>" + button1 + " :</span>"
		);
		...
		var _0x142EB = Neptq("#NJSKEYR_A_UP" + Player + "").attr(
			"data-gamepad-key"
		);
		var _0x1420F = Neptq("#NJSKEYR_A_DOWN" + Player + "").attr("data-value");
		var _0x141E3 = Neptq("#NJSKEYR_A_DOWN" + Player + "").attr(
			"data-gamepad-key"
		);
		var _0x14267 = Neptq("#NJSKEYR_A_LEFT" + Player + "").attr("data-value");
		var _0x1423B = Neptq("#NJSKEYR_A_LEFT" + Player + "").attr(
			"data-gamepad-key"
		);
		var _0x142BF = Neptq("#NJSKEYR_A_RIGHT" + Player + "").attr("data-value");
		var _0x14293 = Neptq("#NJSKEYR_A_RIGHT" + Player + "").attr(
			"data-gamepad-key"
		);
		var _0x14057 = Neptq("#NJSKEYL_A_UP" + Player + "").attr("data-value");
		var _0x1402B = Neptq("#NJSKEYL_A_UP" + Player + "").attr(
			"data-gamepad-key"
		);
		var _0x13F4F = Neptq("#NJSKEYL_A_DOWN" + Player + "").attr("data-value");
		var _0x13F23 = Neptq("#NJSKEYL_A_DOWN" + Player + "").attr(
			"data-gamepad-key"
		);
		var _0x13FA7 = Neptq("#NJSKEYL_A_LEFT" + Player + "").attr("data-value");
		var _0x13F7B = Neptq("#NJSKEYL_A_LEFT" + Player + "").attr(
			"data-gamepad-key"
		);
		var _0x13FFF = Neptq("#NJSKEYL_A_RIGHT" + Player + "").attr("data-value");
		var _0x13FD3 = Neptq("#NJSKEYL_A_RIGHT" + Player + "").attr(
			"data-gamepad-key"
		);
		Neptq("." + NCSS + "labButtonStart").append(
			"" + keyMap[_0x14527] + "" + buttonMap[_0x144FB]
		);
		Neptq("." + NCSS + "labButtonSelect").append(
			"" + keyMap[_0x144CF] + "" + buttonMap[_0x144A3]
		);
		Neptq("." + NCSS + "labButton5").append(
			"" + keyMap[_0x140AF] + "" + buttonMap[_0x14083]
		);
		Neptq("." + NCSS + "labButton6").append(
			"" + keyMap[_0x1436F] + "" + buttonMap[_0x14343]
		);
		Neptq("." + NCSS + "labButtonL1").append(
			"" + keyMap[_0x140AF] + "" + buttonMap[_0x14083]
		);
		Neptq("." + NCSS + "labButtonR1").append(
			"" + keyMap[_0x1436F] + "" + buttonMap[_0x14343]
		);
		Neptq("." + NCSS + "labButtonL2").append(
			"" + keyMap[_0x14107] + "" + buttonMap[_0x140DB]
		);
		Neptq("." + NCSS + "labButtonR2").append(
			"" + keyMap[_0x143C7] + "" + buttonMap[_0x1439B]
		);
		Neptq("." + NCSS + "labButtonL3").append(
			"" + keyMap[_0x1415F] + "" + buttonMap[_0x14133]
		);
		Neptq("." + NCSS + "labButtonR3").append(
			"" + keyMap[_0x1441F] + "" + buttonMap[_0x143F3]
		);
		Neptq("." + NCSS + "labButton1").append(
			"" + keyMap[_0x145D7] + "" + buttonMap[_0x145AB]
		);
		Neptq("." + NCSS + "labButton2").append(
			"" + keyMap[_0x13E47] + "" + buttonMap[_0x13E1B]
		);
		Neptq("." + NCSS + "labButton3").append(
			"" + keyMap[_0x13E9F] + "" + buttonMap[_0x13E73]
		);
		Neptq("." + NCSS + "labButton4").append(
			"" + keyMap[_0x1462F] + "" + buttonMap[_0x14603]
		);
		Neptq("." + NCSS + "labButtonUP").append(
			"" + keyMap[_0x1457F] + "" + buttonMap[_0x14553]
		);
		Neptq("." + NCSS + "labButtonDown").append(
			"" + keyMap[_0x13EF7] + "" + buttonMap[_0x13ECB]
		);
		Neptq("." + NCSS + "labButtonLeft").append(
			"" + keyMap[_0x141B7] + "" + buttonMap[_0x1418B]
		);
		Neptq("." + NCSS + "labButtonRight").append(
			"" + keyMap[_0x14477] + "" + buttonMap[_0x1444B]
		);
		Neptq("." + NCSS + "labanUPL").append(
			"" + keyMap[_0x14057] + "" + buttonMap[_0x1402B]
		);
		Neptq("." + NCSS + "labanDownL").append(
			"" + keyMap[_0x13F4F] + "" + buttonMap[_0x13F23]
		);
		Neptq("." + NCSS + "labanLeftL").append(
			"" + keyMap[_0x13FA7] + "" + buttonMap[_0x13F7B]
		);
		Neptq("." + NCSS + "labanRightL").append(
			"" + keyMap[_0x13FFF] + "" + buttonMap[_0x13FD3]
		);
		Neptq("." + NCSS + "labanUPR").append(
			"" + keyMap[_0x14317] + "" + buttonMap[_0x142EB]
		);
		Neptq("." + NCSS + "labanDownR").append(
			"" + keyMap[_0x1420F] + "" + buttonMap[_0x141E3]
		);
		Neptq("." + NCSS + "labanLeftR").append(
			"" + keyMap[_0x14267] + "" + buttonMap[_0x1423B]
		);
		Neptq("." + NCSS + "labanRightR").append(
			"" + keyMap[_0x142BF] + "" + buttonMap[_0x14293]
		);
	}
	...
	function _0x13FD3(_0x13E1B) {
		if (_0x13E1B.index === 0) {
			...
			Neptq("#" + NCSS + "gbadinfo1 , #" + NCSS + "gamepadinfo1").css(
				"display",
				"none"
			);
		}
		if (_0x13E1B.index === 1) {
			...
			Neptq("#" + NCSS + "gbadinfo2 , #" + NCSS + "gamepadinfo2").css(
				"display",
				"none"
			);
		}
		if (_0x13E1B.index === 2) {
			...
			Neptq("#" + NCSS + "gbadinfo3 , #" + NCSS + "gamepadinfo3").css(
				"display",
				"none"
			);
		}
		if (_0x13E1B.index === 3) {
			...
			Neptq("#" + NCSS + "gbadinfo4 , #" + NCSS + "gamepadinfo4").css(
				"display",
				"none"
			);
		}
	...
	function _0x14083() {
		Neptq("." + NCSS + "advance_tabs" + Player + "").toggleClass(
			"" + NCSS + "advance_tabs_active"
		);
	}

	function _0x140AF() {
		Neptq("." + NCSS + "tabs-panel")
			.not(document.getElementById("" + NCSS + "controller-1"))
			.css("display", "none");
	...
	function _0x1420F() {
		...
		if (window.localStorage) {
			window.localStorage.setItem(
				"" + romTitle + "_" + NeptunP + "_NJScontrollers",
				JSON.stringify(controllers)
			);
		}
		Neptq("#" + NCSS + "NepCui").css("display", "none");
	...
	function _0x1423B() {
		...
		if (
			localStorage.getItem("" + NeptunP + "_NJScontrollers") === null ||
			resetControll === 1
		) {
			if (xboxMode === true) {
	...
	function _0x14267() {
		if (
			...
			var _0x13E1B = localStorage.getItem(
				"" + romTitle + "_" + NeptunP + "_NJScontrollers"
			);
			controllers = JSON.parse(_0x13E1B);
		}
	...
	function _0x14293(_0x13E1B) {
		...
		Neptq(this)
			.parent()
			.addClass("" + NCSS + "is-active");
		Neptq(this)
			.parent()
			.siblings()
			.removeClass("" + NCSS + "is-active");
	...
	function _0x142EB() {
		Neptq.each(controllers, function (_0x13E1B, _0x13E47) {
			Neptq.each(_0x13E47, function (_0x13E9F, _0x13E47) {
				...
				_0x13E73
					.attr("data-gamepad-index", _0x13E47.index)
					.attr("data-value", _0x13E47.value)
					.attr("data-type", _0x13E47.type)
					.attr("data-gamepad-key", _0x13E47.gamepad_key);
				_0x13E73.val(
					"" + keyMap[_0x13E47.value] + "" + buttonMap[_0x13E47.gamepad_key]
				);
	...
	function _0x1436F(_0x13E47) {
		if (popset === 1) {
			...
			if (
				!_0x13E1B.is(_0x13E47.target) &&
				_0x13E1B.has(_0x13E47.target).length === 0
			) {
				_0x13E73.css({
					visibility: "hidden",
					opacity: "0",
	...
	function _0x14553() {
		...
		if (
			NjsconsoleInfo.indexOf("RetroArch [INFO] :: Ejected virtual disk tray.") >
			-1
		) {
			Neptq("." + NCSS + "nep_swap_disc").addClass("" + NCSS + "active_info");
			setTimeout(function () {
				Neptq("." + NCSS + "nep_swap_disc").removeClass(
					"" + NCSS + "active_info"
				);
	...
	function _0x145AB() {
		if (RI.contexts.length === 0) {
			...
			function _0x13E1B(_0x13E1B, _0x13E47) {
				Neptq(":focus")
					.val(buttonMap[_0x13E1B])
					.attr("data-type", 2)
					.attr("data-gamepad-key", _0x13E1B)
					.attr("data-axes-key", _0x13E47);
			}
				...
				if (_0x13F23.axis == "LEFT_STICK_X") {
					...
					if (_0x13F23.value <= 0.5) {
						...
						for (var _0x13F4F in controllers) {
							for (var _0x13F7B in controllers[_0x13F4F]) {
								...
								if (
									_0x13EF7.gamepad_key == axes_stick_up &&
									_0x13F23.gamepad.index == _0x13EF7.index
								) {
					...
					for (var _0x13F4F in controllers) {
						for (var _0x13F7B in controllers[_0x13F4F]) {
							var _0x13EF7 = controllers[_0x13F4F][_0x13F7B];
							if (
								_0x13EF7.gamepad_key == axes_stick &&
								_0x13F23.gamepad.index == _0x13EF7.index
							) {
								simulat_input = _0x13EF7.input_key;
							} else {
			...
			gamepad.bind(Gamepad.Event.BUTTON_DOWN, function (_0x13E73) {
				if (Neptq(":focus").closest("." + NCSS + "controllers").length > 0) {
					Neptq(":focus")
						.val(keyMap[keyCod_tag] + "" + buttonMap[_0x13E73.control])
						.attr("data-type", 2)
						.attr("data-gamepad-key", _0x13E73.control)
						.attr("data-gamepad-index", _0x13E73.gamepad.index);
				}
				for (var _0x13E9F in controllers) {
					for (var _0x13ECB in controllers[_0x13E9F]) {
						var _0x13E47 = controllers[_0x13E9F][_0x13ECB];
						if (
							_0x13E47.gamepad_key == _0x13E73.control &&
							_0x13E73.gamepad.index == _0x13E47.index
						) {
							simulat_input = _0x13E47.input_key;
						}
					}
			...
			focusElement[0].addEventListener(
				"mousedown",
	...
	function _0x14603(_0x13E1B) {
		if (_0x13E1B === RI.contexts.length) {
			...
			if (RI.contexts.length === 0) {
				...
				Neptune.canvas.removeEventListener(
					"mouseup",
					RI.canvasEventHandler,
					false
				);
			...
			gamepad.bind(Gamepad.Event.BUTTON_UP, function (_0x13E47) {
				if (Neptq("#" + NCSS + "popup1").is(":focus")) {
					...
					Neptq("input").each(function () {
						...
						if (
							attrData == _0x13E47.control &&
							DataIndex == _0x13E47.gamepad.index
						) {
							Neptq("#" + theHidden).attr("data-gamepad-key", "4545");
						}
					});
					Neptq("." + NCSS + "charkey").html(
						"Button set to " +
							_0x13E1B +
							" gamepad \u2116" +
							(_0x13E47.gamepad.index + 1)
					);
					Neptq("." + NCSS + "charkey").css("display", "block");
					if (elementData === "" + NCSS + "ConStart") {
						Neptq("#NJSSTART" + Player + "")
							.attr("data-type", 2)
							.attr("data-gamepad-key", _0x13E47.control)
							.attr("data-gamepad-index", _0x13E47.gamepad.index);
					}
					if (elementData === "" + NCSS + "ConSelect") {
						Neptq("#NJSSELECT" + Player + "")
							.attr("data-type", 2)
							.attr("data-gamepad-key", _0x13E47.control)
							.attr("data-gamepad-index", _0x13E47.gamepad.index);
					}
					if (elementData === "" + NCSS + "ConL1") {
						Neptq("#NJSKEYL" + Player + "")
							.attr("data-type", 2)
							.attr("data-gamepad-key", _0x13E47.control)
							.attr("data-gamepad-index", _0x13E47.gamepad.index);
					}
					if (elementData === "" + NCSS + "ConR1") {
						Neptq("#NJSKEYR" + Player + "")
							.attr("data-type", 2)
							.attr("data-gamepad-key", _0x13E47.control)
							.attr("data-gamepad-index", _0x13E47.gamepad.index);
					}
					if (elementData === "" + NCSS + "ConL2") {
						Neptq("#NJSKEYL2" + Player + "")
							.attr("data-type", 2)
							.attr("data-gamepad-key", _0x13E47.control)
							.attr("data-gamepad-index", _0x13E47.gamepad.index);
					}
					if (elementData === "" + NCSS + "ConR2") {
						Neptq("#NJSKEYR2" + Player + "")
							.attr("data-type", 2)
							.attr("data-gamepad-key", _0x13E47.control)
							.attr("data-gamepad-index", _0x13E47.gamepad.index);
					}
					if (elementData === "" + NCSS + "ConL3") {
						Neptq("#NJSKEYL3" + Player + "")
							.attr("data-type", 2)
							.attr("data-gamepad-key", _0x13E47.control)
							.attr("data-gamepad-index", _0x13E47.gamepad.index);
					}
					if (elementData === "" + NCSS + "ConR3") {
						Neptq("#NJSKEYR3" + Player + "")
							.attr("data-type", 2)
							.attr("data-gamepad-key", _0x13E47.control)
							.attr("data-gamepad-index", _0x13E47.gamepad.index);
					}
					if (elementData === "" + NCSS + "cui_button1") {
						Neptq("#NJSKEYX" + Player + "")
							.attr("data-type", 2)
							.attr("data-gamepad-key", _0x13E47.control)
							.attr("data-gamepad-index", _0x13E47.gamepad.index);
					}
					if (elementData === "" + NCSS + "cui_button2") {
						Neptq("#NJSKEYA" + Player + "")
							.attr("data-type", 2)
							.attr("data-gamepad-key", _0x13E47.control)
							.attr("data-gamepad-index", _0x13E47.gamepad.index);
					}
					if (elementData === "" + NCSS + "cui_button3") {
						Neptq("#NJSKEYB" + Player + "")
							.attr("data-type", 2)
							.attr("data-gamepad-key", _0x13E47.control)
							.attr("data-gamepad-index", _0x13E47.gamepad.index);
					}
					if (elementData === "" + NCSS + "cui_button4") {
						Neptq("#NJSKEYY" + Player + "")
							.attr("data-type", 2)
							.attr("data-gamepad-key", _0x13E47.control)
							.attr("data-gamepad-index", _0x13E47.gamepad.index);
					}
					...
					if (elementData === "" + NCSS + "cui_button9") {
						Neptq("#NJSKEYR_A_UP" + Player + "")
							.attr("data-type", 2)
							.attr("data-gamepad-key", _0x13E47.control)
							.attr("data-gamepad-index", _0x13E47.gamepad.index);
					}
					if (elementData === "" + NCSS + "cui_button10") {
						Neptq("#NJSKEYR_A_DOWN" + Player + "")
							.attr("data-type", 2)
							.attr("data-gamepad-key", _0x13E47.control)
							.attr("data-gamepad-index", _0x13E47.gamepad.index);
					}
					if (elementData === "" + NCSS + "cui_button11") {
						Neptq("#NJSKEYR_A_LEFT" + Player + "")
							.attr("data-type", 2)
							.attr("data-gamepad-key", _0x13E47.control)
							.attr("data-gamepad-index", _0x13E47.gamepad.index);
					}
					if (elementData === "" + NCSS + "cui_button12") {
						Neptq("#NJSKEYR_A_RIGHT" + Player + "")
							.attr("data-type", 2)
							.attr("data-gamepad-key", _0x13E47.control)
							.attr("data-gamepad-index", _0x13E47.gamepad.index);
					}
					...
					if (elementData === "" + NCSS + "dpadd") {
						Neptq("#NJSDOWN" + Player + "")
							.attr("data-type", 2)
							.attr("data-gamepad-key", _0x13E47.control)
							.attr("data-gamepad-index", _0x13E47.gamepad.index);
					}
					if (elementData === "" + NCSS + "dpadl") {
						Neptq("#NJSLEFT" + Player + "")
							.attr("data-type", 2)
							.attr("data-gamepad-key", _0x13E47.control)
							.attr("data-gamepad-index", _0x13E47.gamepad.index);
					}
					if (elementData === "" + NCSS + "dpadr") {
						Neptq("#NJSRIGHT" + Player + "")
							.attr("data-type", 2)
							.attr("data-gamepad-key", _0x13E47.control)
							.attr("data-gamepad-index", _0x13E47.gamepad.index);
					}
					if (elementData === "" + NCSS + "AnalogLu") {
						Neptq("#NJSKEYL_A_UP" + Player + "")
							.attr("data-type", 2)
							.attr("data-gamepad-key", _0x13E47.control)
							.attr("data-gamepad-index", _0x13E47.gamepad.index);
					}
					if (elementData === "" + NCSS + "AnalogLd") {
						Neptq("#NJSKEYL_A_DOWN" + Player + "")
							.attr("data-type", 2)
							.attr("data-gamepad-key", _0x13E47.control)
							.attr("data-gamepad-index", _0x13E47.gamepad.index);
					}
					if (elementData === "" + NCSS + "AnalogLl") {
						Neptq("#NJSKEYL_A_LEFT" + Player + "")
							.attr("data-type", 2)
							.attr("data-gamepad-key", _0x13E47.control)
							.attr("data-gamepad-index", _0x13E47.gamepad.index);
					}
					if (elementData === "" + NCSS + "AnalogLr") {
						Neptq("#NJSKEYL_A_RIGHT" + Player + "")
							.attr("data-type", 2)
							.attr("data-gamepad-key", _0x13E47.control)
							.attr("data-gamepad-index", _0x13E47.gamepad.index);
					}
				...
				if (Neptq("#" + NCSS + "popup1").is(":focus")) {
					...
					if (axes_stick > 0) {
						...
						if (elementData === "" + NCSS + "ConStart") {
							Neptq("#NJSSTART" + Player + "")
								.attr("data-type", 2)
								.attr("data-gamepad-key", axes_stick)
								.attr("data-axes-key", axes_stick_up)
								.attr("data-gamepad-index", _0x13E47.gamepad.index);
						}
						...
						var _0x13E73 = setTimeout(function () {
							...
							Neptq("#" + NCSS + "popup1").css("zIndex", "0");
							Neptq(
								"." + NCSS + "tabs-content ." + NCSS + "controllers"
							).focus();
						}, 600);
					}
				}
	...
	if (netp === 1) {
		...
		Neptq("." + NCSS + "setting-controllers ." + NCSS + "submit").click(
			_0x14343
		);
